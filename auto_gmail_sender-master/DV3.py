    ...
    with smtplib.SMTP_SSL("smtp.gmail.com", 465, context=context) as server:
        ...
        with open(file_path, mode="r") as file:
            ...
            for row in reader:
                ...
                # Create a personalized message by appending selected field labels and values to the body
                personalized_message = body
                for field, value in data.items():
                    personalized_message += f"<br>{field}: {value}"

                # Substitute the updated body in the message template
                full_message = message_template.format(body=personalized_message)
                ...
                part = MIMEText(full_message, "html")
                message.attach(part)
